...
variables_outcome <- outcome_long %>% 
  ...
  mutate(description = 
           case_when(variable == "psychs_pos_tot"                            ~ 'PSYCHS Total Score',
                     ...
                     variable == "tobacco"       ~ 'Severity of use: tobacco',
                     variable == "alcohol"       ~ 'Severity of use: alcohol',                                 
                     variable == "cannabis"      ~ 'Severity of use: cannabis',
                     variable == "cocaine"       ~ 'Severity of use: cocaine',                                 
                     variable == "amphetamines"  ~ 'Severity of use: amphetamines',
                     variable == "inhalants"     ~ 'Severity of use: inhalants',                               
                     variable == "sedatives"     ~ 'Severity of use: sedatives',
                     variable == "hallucinogens" ~ 'Severity of use: hallucinogens',
                     variable == "opiods"        ~ 'Severity of use: opiods',
                     variable == "other"         ~ 'Severity of use: other',                                   
                     variable == "childhood_subtotal"                 ~ 'PAS: Childhood',
                     variable == "early_adolescence_subtotal"         ~ 'PAS: Early Adolescence',              
                     variable == "late_adolescence_subtotal"          ~ 'PAS: Late Adolescence',
                     variable == "adulthood_subtotal"                 ~ 'PAS: Adulthood',                      
                     variable == "total_score_only_childhood"         ~ 'PAS: Only Childhood',
                     variable == "total_score_upto_early_adolescence" ~ 'PAS: Up to early adolescence',      
                     variable == "total_score_upto_late_adolescence"  ~ 'PAS: Up to late adolescence',
                     variable == "total_score_upto_adulthood"         ~ 'PAS: Up to Adulthood',              
                     variable == "cssrs_intensity_lifetime"           ~ 'CSSRS (Suicide intensity): Lifetime',
                     variable == "cssrs_intensity_pastmonth"          ~ 'CSSRS (Suicide intensity): Past Month',               
                     ...
                     variable == "promis_total"                       ~ 'Sleep quality (PROMIS)',                            
                     variable == "decline_in_global_role_functioning" ~ 'Decline in role functioning (highest score in lifetime - current score)',
                     variable == "decline_in_global_social_functioning" ~ 'Decline in social functioning (highest score in lifetime - current score)',    
                     variable == "nsipr_motivation_and_pleasure_dimension" ~ 'Motivation and Pleasure (NSIPR)',
                     variable == "nsipr_diminished_expression_dimension" ~ 'Diminished Expression Dimension (NSIPR)',  
                     variable == "nsipr_avolition_domain" ~ 'Avolition (NSIPR)',
                     variable == "nsipr_asociality_domain" ~ 'Asociality (NSIPR)',                 
                     variable == "nsipr_anhedonia_domain" ~ 'Anhedonia (NSIPR)',
                     variable == "nsipr_blunted_affect_domain" ~ 'Blunted Affect (NSIPR)',             
                     ...
                     variable == "pds_total_score_female_sex" ~ 'Pubertal developmental scale: total score',                     
                     variable == "pds_total_score_male_sex" ~ 'Pubertal developmental scale: total score',                     
                     variable == "chrpds_pds_f5b_p" ~ 'Menarche: Yes/No',
                     variable == "chrbprs_bprs_total" ~ 'BRPS: Total score',                              
                     variable == "bprs_affect_subscale" ~ 'BRPS: Affect subscale',
                     variable == "bprs_positive_symptom_subscale" ~ 'BRPS: Positive symptoms subscale',          
                     variable == "bprs_negative_symptom_subscale" ~ 'BRPS: Negative symptoms subscale',
                     variable == "bprs_activation_subscale" ~ 'BRPS: Activation subscale',
                     variable == "bprs_disorganization_subscale" ~ 'BRPS: Disorganization',
                     variable == "oasis_total" ~ 'OASIS total (Anxiety)',                             
                     variable == "perceived_discrimination_total" ~ 'Total score of Perceived discrimination',
                     variable == "cdss_total" ~ 'Total of depressive symptoms (CDSS)',                              
                     variable == "perceived_stress_scale_total" ~ 'Total of perceived stress'))%>%
  mutate(diverging_expert_variable_name = 
           case_when(variable == "psychs_pos_tot"        ~ 'PSYCHS Total Score',
                     ...
                     variable == "opiods"        ~ '',
                     variable == "other"         ~ '',                                   
                     variable == "childhood_subtotal"                 ~ '',
                     variable == "early_adolescence_subtotal"         ~ '',              
                     variable == "late_adolescence_subtotal"          ~ '',
                     variable == "adulthood_subtotal"                 ~ '',                      
                     variable == "total_score_only_childhood"         ~ '',
                     variable == "total_score_upto_early_adolescence" ~ '',      
                     variable == "total_score_upto_late_adolescence"  ~ '',
                     variable == "total_score_upto_adulthood"         ~ '',              
                     variable == "cssrs_intensity_lifetime"           ~ '',
                     variable == "cssrs_intensity_pastmonth"          ~ '',               
                     variable == "chrpred_transition"                 ~ '',
                     variable == "chrpred_experience"                 ~ '',                      
                     variable == "chrpgi_2"                           ~ '',
                     variable == "promis_total"                       ~ 'A total of the 8 items with very poor being 1 and up to very good being 5',                            
                     variable == "decline_in_global_role_functioning" ~ '',
                     variable == "decline_in_global_social_functioning" ~ '',    
                     variable == "nsipr_motivation_and_pleasure_dimension" ~ '',
                     variable == "nsipr_diminished_expression_dimension" ~ '',  
                     variable == "nsipr_avolition_domain" ~ '',
                     variable == "nsipr_asociality_domain" ~ '',                 
                     variable == "nsipr_anhedonia_domain" ~ '',
                     variable == "nsipr_blunted_affect_domain" ~ '',             
                     ...
                     variable == "pds_total_score_sex" ~ 'PDS total score female sex/PDS total score male sex',                     
                     variable == "chrpds_pds_f5b_p" ~ 'pds_menarche',
                     variable == "chrbprs_bprs_total" ~ 'bprs_total',                              
                     variable == "bprs_affect_subscale" ~ '',
                     variable == "bprs_positive_symptom_subscale" ~ '',          
                     variable == "bprs_negative_symptom_subscale" ~ '',
                     variable == "bprs_activation_subscale" ~ '',
                     variable == "bprs_disorganization_subscale" ~ '',
                     variable == "oasis_total" ~ '',                             
                     variable == "perceived_discrimination_total" ~ '',
                     variable == "cdss_total" ~ '',                              
                     variable == "perceived_stress_scale_total" ~ ''))%>%
  mutate(Experts = 
           case_when(
  ...
  mutate(Notes = 
           case_when(variable == "psychs_pos_tot"                          ~ 'chrpsychs_scr_1d1+chrpsychs_scr_2d1+chrpsychs_scr_3d1+chrpsychs_scr_4d5+chrpsychs_scr_5d1+chrpsychs_scr_6d1+chrpsychs_scr_7d1+chrpsychs_scr_8d1+chrpsychs_scr_9d1+chrpsychs_scr_10d1+chrpsychs_scr_11d1+chrpsychs_scr_12d1+chrpsychs_scr_13d1+chrpsychs_scr_14d1+chrpsychs_scr_15d1',
                     ...
                     variable == "chrpps_sum13"                            ~ 'chrpps_sum13=4 sum(chrpps_lazy chrpps_born, chrpps_hate, chrpps_hurt, chrpps_emoab, chrpps_doc, chrpps_bruise, chrpps_belt, chrpps_physab,  chrpps_beat, chrpps_touch, chrpps_threat, chrpps_sexual, chrpps_molest, chrpps_sexab, chrpps_loved(R), chrpps_special(R), chrpps_care(R), chrpps_closefam(R), chrpps_support(R), chrpps_hunger, chrpps_protect(R), chrpps_pardrunk, chrpps_dirty, chrpps_docr(R)) >55 else chrpps_sum13=-0.5',
                     ...
                     variable == "tobacco"                                 ~ 'chrassist_whoassist_often1 + chrassist_whoassist_urge1 + chrassist_whoassist_prob1 + chrassist_whoassist_fail1 +  chrassist_whoassist_concern1 + chrassist_whoassist_control1',
                     variable == "alcohol"                                 ~ 'chrassist_whoassist_often2 + chrassist_whoassist_urge2 + chrassist_whoassist_prob2 + chrassist_whoassist_fail2 +  chrassist_whoassist_concern2 + chrassist_whoassist_control2',                                 
                     variable == "cannabis"                                ~ 'chrassist_whoassist_often3 + chrassist_whoassist_urge3 + chrassist_whoassist_prob3 + chrassist_whoassist_fail3 +  chrassist_whoassist_concern3 + chrassist_whoassist_control3',
                     variable == "cocaine"                                 ~ 'chrassist_whoassist_often4 + chrassist_whoassist_urge4 + chrassist_whoassist_prob4 + chrassist_whoassist_fail4 +  chrassist_whoassist_concern4 + chrassist_whoassist_control4',                                 
                     variable == "amphetamines"                            ~ 'chrassist_whoassist_often5 + chrassist_whoassist_urge5 + chrassist_whoassist_prob5 + chrassist_whoassist_fail5 +  chrassist_whoassist_concern5 + chrassist_whoassist_control5',
                     variable == "inhalants"                               ~ 'chrassist_whoassist_often6 + chrassist_whoassist_urge6 + chrassist_whoassist_prob6 + chrassist_whoassist_fail6 +  chrassist_whoassist_concern6 + chrassist_whoassist_control6',                               
                     variable == "sedatives"                               ~ 'chrassist_whoassist_often7 + chrassist_whoassist_urge7 + chrassist_whoassist_prob7 + chrassist_whoassist_fail7 +  chrassist_whoassist_concern7 + chrassist_whoassist_control7',
                     variable == "hallucinogens"                           ~ 'chrassist_whoassist_often8 + chrassist_whoassist_urge8 + chrassist_whoassist_prob8 + chrassist_whoassist_fail8 +  chrassist_whoassist_concern8 + chrassist_whoassist_control8',
                     variable == "opiods"                                  ~ 'chrassist_whoassist_often9 + chrassist_whoassist_urge9 + chrassist_whoassist_prob9 + chrassist_whoassist_fail9 +  chrassist_whoassist_concern9 + chrassist_whoassist_control9',
                     variable == "other"                                   ~ 'chrassist_whoassist_often10 + chrassist_whoassist_urge10 + chrassist_whoassist_prob10 + chrassist_whoassist_fail10 +  chrassist_whoassist_concern10 + chrassist_whoassist_control10',                                   
                     variable == "childhood_subtotal"                      ~ '(chrpas_pmod_child1+chrpas_pmod_child2+chrpas_pmod_child3+chrpas_pmod_child4)/24',
                     variable == "early_adolescence_subtotal"              ~ '(chrpas_pmod_adol_early1+chrpas_pmod_adol_early2+chrpas_pmod_adol_early3+chrpas_pmod_adol_early4+chrpas_pmod_adol_early5)/30',              
                     variable == "late_adolescence_subtotal"               ~ '(chrpas_pmod_adol_late1+chrpas_pmod_adol_late2+chrpas_pmod_adol_late3+chrpas_pmod_adol_late4+chrpas_pmod_adol_late5)/30',
                     variable == "adulthood_subtotal"                      ~ '(chrpas_pmod_adult1+chrpas_pmod_adult2+(chrpas_pmod_adult3v1 or + chrpas_pmod_adult3v3))/18',                      
                     variable == "total_score_only_childhood"              ~ 'Childhood subtotal',
                     variable == "total_score_upto_early_adolescence"      ~ '(Childhood subtotal +Early Adolescence subtotal)/2',      
                     variable == "total_score_upto_late_adolescence"       ~ '(Childhood subtotal +Early Adolescence subtotal+Late Adolescence subtotal)/3',
                     variable == "total_score_upto_adulthood"              ~ '(Childhood subtotal +Early Adolescence subtotal+Late Adolescence subtotal+Adulthood subtotal)/4',              
                     variable == "cssrs_intensity_lifetime"                ~ 'chrcssrsb_sidfrql + chrcssrsb_siddurl + chrcssrsb_sidctrl + chrcssrs_siddtrl + chrcssrsb_sidrsnl',
                     variable == "cssrs_intensity_pastmonth"               ~ 'chrcssrsb_css_sipmfreq + chrcssrsb_css_sipmdur + chrcssrsb_css_sipmctrl + chrcssrsb_css_sipmdet + chrcssrsb_css_sipmreas',               
                     variable == "chrpred_transition"                      ~ 'Redcap variable',
                     variable == "chrpred_experience"                      ~ 'Redcap variable',                      
                     variable == "chrpgi_2"                                ~ 'Redcap variable',
                     variable == "promis_total"                            ~ 'chrpromis_sleep109+chrpromis_sleep116+(6-chrpromis_sleep20)+(6-chrpromis_sleep44)+(6-chrpromise_sleep108)+(6-chrpromis_sleep72)+(6-chrpromis_sleep67)+chrpromis_sleep115',                            
                     variable == "decline_in_global_role_functioning"      ~ 'chrgfr_gf_role_high-chrgfr_gf_role_scole',
                     variable == "decline_in_global_social_functioning"    ~ 'chrgfs_gf_social_high-chrgfs_gf_social_scale ',    
                     variable == "nsipr_motivation_and_pleasure_dimension" ~ '(chrnsipr_item1 + chrnsipr_item2 + chrnsipr_item3 + chrnsipr_item4 + chrnsipr_item5 + chrnsipr_item6 + chrnsipr_item7)/7',
                     variable == "nsipr_diminished_expression_dimension"   ~ '(chrnsipr_item8 + chrnsipr_item9 + chrnsipr_item10 + chrnsipr_item11)/4',   
                     variable == "nsipr_avolition_domain"                  ~ '(chrnsipr_item1 + chrnsipr_item2)/2',
                     variable == "nsipr_asociality_domain"                 ~ '(chrnsipr_item3 + chrnsipr_item4 + chrnsipr_item5)/3',                 
                     variable == "nsipr_anhedonia_domain"                  ~ '(chrnsipr_item6 + chrnsipr_item7)/2',
                     variable == "nsipr_blunted_affect_domain"             ~ '(chrnsipr_item8 + chrnsipr_item9 + chrnsipr_item10)/3',             
                     ...
                     variable == "pds_total_score_female_sex"              ~ 'if female: chrpds_pds_1_p + chrpds_pds_2_p + chrpds_pds_3_p + chrpds_pds_f4_p + chrpds_pds_f5b_p, if male: -300',                     
                     variable == "pds_total_score_male_sex"                ~ 'if female: -300 if male: chrpds_pds_1_p + chrpds_pds_2_p + chrpds_pds_3_p + chrpds_pds_m4_p + chrpds_pds_m5_p',                     
                     variable == "chrpds_pds_f5b_p"                        ~ 'Redcap variable',
                     variable == "chrbprs_bprs_total"                      ~ 'Redcap variable',                              
                     variable == "bprs_affect_subscale"                    ~ 'chrbprs_bprs_depr+chrbprs_bprs_suic+chrbprs_depr_guil',
                     variable == "bprs_positive_symptom_subscale"          ~ 'chrbprs_bprs_unus+chrbprs_bprs_hall+chrbprs_bprs_susp',          
                     variable == "bprs_negative_symptom_subscale"          ~ 'chrbprs_bprs_blun+chrbprs_bprs_motr+chrbprs_bprs_emot',
                     variable == "bprs_activation_subscale"                ~ 'chrbprs_bprs_exci+chrbprs_bprs_mohy+chrbprs_bprs_elat ',
                     variable == "bprs_disorganization_subscale"           ~ 'chrbprs_bprs_diso+chrbprs_bprs_conc+chrbprs_bprs_self',
                     variable == "oasis_total"                             ~ 'chroasis_oasis_1+chroasis_oasis_2+chroasis_oasis_3+chroasis_oasis_4+chroasis_oasis_5',                             
                     variable == "perceived_discrimination_total"          ~ 'chrdim_dim_yesno_q1_1+chrdim_dim_yesno_q1_2+chrdlm_dim_sex+chrdlm_dim_yesno_age+chrdlm_dim_yesno_q4_1+chrdlm_dim_yesno_q5+chrdlm_dim_yesno_q3+chrdlm_dim_yesno_q6+chrdlm_dim_yesno_other',
                     variable == "cdss_total"                              ~ 'chrcdss_calg1 + chrcdss_calg2+chrcdss_calg3+chrcdss_calg4+chrcdss_calg5+chrcdss_calg6+chrcdss_calg7+chrcdss_calg8+chrcdss_calg9',                              
                     variable == "perceived_stress_scale_total"            ~ 'chrpss_pssp1_1+chrpss_pssp1_2+chrpss_pssp1_3+chrpss_pssp2_1+chrpss_pssp2_2+chrpss_pssp2_3+chrpss_pssp2_4+chrpss_pssp2_5+chrpss_pssp3_1+chrpss_pssp3_4'))%>%
  ...
  mutate(original_calculation_adapted_np_or_comment = 
           case_when(variable == "psychs_pos_tot"        ~ '',
                     ...
                     variable == "tobacco" ~ 'Additionally, to the sum we consider whether individual ever consumed the substance. If not this score is 0',
                     variable == "alcohol" ~ 'Additionally, to the sum we consider whether individual ever consumed the substance. If not this score is 0',                                 
                     variable == "cannabis" ~ 'Additionally, to the sum we consider whether individual ever consumed the substance. If not this score is 0',
                     variable == "cocaine" ~ 'Additionally, to the sum we consider whether individual ever consumed the substance. If not this score is 0',                                 
                     variable == "amphetamines" ~ 'Additionally, to the sum we consider whether individual ever consumed the substance. If not this score is 0',
                     variable == "inhalants" ~ 'Additionally, to the sum we consider whether individual ever consumed the substance. If not this score is 0',                               
                     variable == "sedatives" ~ 'Additionally, to the sum we consider whether individual ever consumed the substance. If not this score is 0',
                     variable == "hallucinogens" ~ 'Additionally, to the sum we consider whether individual ever consumed the substance. If not this score is 0',
                     variable == "opiods" ~ 'Additionally, to the sum we consider whether individual ever consumed the substance. If not this score is 0',
                     variable == "other" ~ 'Additionally, to the sum we consider whether individual ever consumed the substance. If not this score is 0',                                   
                     variable == "childhood_subtotal" ~ '',
                     variable == "early_adolescence_subtotal" ~ '',              
                     variable == "late_adolescence_subtotal" ~ '',
                     variable == "adulthood_subtotal" ~ '',                      
                     ...
                     variable == "total_score_upto_late_adolescence" ~ '',
                     variable == "total_score_upto_adulthood" ~ '',              
                     variable == "cssrs_intensity_lifetime" ~ 'Before the sum score calculation: if someone never had suicidal thoughts in a lifetime (chrcssrsb_si1l and chrcssrsb_si2l == 0), cssrs intensity for lifetime and past month should be zero.',
                     variable == "cssrs_intensity_pastmonth" ~ 'Before the sum score calculation: if someone never had suicidal thoughts in a lifetime (chrcssrsb_si1l and chrcssrsb_si2l == 0) or in the past month (chrcssrsb_css_sim1 and chrcssrsb_css_sim1 == 0), cssrs intensity for lifetime and past month should be zero.',               
                     variable == "chrpred_transition" ~ '',
                     variable == "chrpred_experience" ~ '',                      
                     variable == "chrpgi_2" ~ '',
                     variable == "promis_total" ~ '',                            
                     variable == "decline_in_global_role_functioning" ~ '',
                     variable == "decline_in_global_social_functioning" ~ '',    
                     variable == "nsipr_motivation_and_pleasure_dimension" ~ '',
                     variable == "nsipr_diminished_expression_dimension" ~ '',   
                     ...
                     variable == "pds_total_score_sex" ~ 'Other than in the outcome calculation we have only one score instead of female/male. Depending on which sex the individual was assigned at birth. We then calculate the score based on the originally provided calculations.',                     
  ...
  mutate(value_range = case_when( variable == "psychs_pos_tot"             ~ '0::90',
                                  ...
                                  variable == "cocaine"       ~ '0::39',                                 
                                  variable == "amphetamines"  ~ '0::39',
                                  variable == "inhalants"     ~ '0::39',                               
                                  variable == "sedatives"     ~ '0::39',
                                  variable == "hallucinogens" ~ '0::39',
                                  variable == "opiods"        ~ '0::39',
                                  variable == "other"         ~ '0::39',                                   
                                  variable == "childhood_subtotal"                 ~ '0::24',
                                  variable == "early_adolescence_subtotal"         ~ '0::30',              
                                  variable == "late_adolescence_subtotal"          ~ '0::30',
                                  variable == "adulthood_subtotal"                 ~ '0::18',                      
                                  ...
                                  variable == "decline_in_global_social_functioning" ~ '0::10',    
                                  variable == "nsipr_motivation_and_pleasure_dimension" ~ '0::5',
                                  variable == "nsipr_diminished_expression_dimension" ~ '0::5',  
                                  variable == "nsipr_avolition_domain" ~ '0::5',
                                  variable == "nsipr_asociality_domain" ~ '0::5',                 
                                  variable == "nsipr_anhedonia_domain" ~ '0::5',
                                  variable == "nsipr_blunted_affect_domain" ~ '0::5',             
                                  ...
                                  variable == "pds_total_score_female_sex" ~ '5::20',                     
                                  variable == "pds_total_score_male_sex" ~   '5::20',                     
                                  variable == "chrpds_pds_f5b_p" ~           '1;4',
                                  variable == "chrbprs_bprs_total" ~             '24::168',                              
                                  variable == "bprs_affect_subscale" ~           '3::21',
                                  variable == "bprs_positive_symptom_subscale" ~ '3::21',          
                                  variable == "bprs_negative_symptom_subscale" ~ '3::21',
                                  variable == "bprs_activation_subscale" ~       '3::21',
                                  variable == "bprs_disorganization_subscale" ~  '3::21',
                                  variable == "oasis_total" ~ '0::20',                             
